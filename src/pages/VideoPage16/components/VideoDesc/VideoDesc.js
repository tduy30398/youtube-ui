            ...
            {isShowMore ? (
                <div className={cx('video-description-wrapper')}>
                    <p className={cx('video-description')}>
                        ARSENAL - TOTTENHAM | PHÁO THỦ BÙNG NỔ, GÀ TRỐNG NGẬM NGÙI SAU TẤM THẺ ĐỎ |<br /> NGOẠI HẠNG ANH
                        22/23
                    </p>
                ...
                <div className={cx('video-description-wrapper')}>
                    <p className={cx('video-description')}>
                        ...
                        <br />
                        <br />
                        #NgoaiHangAnh #KplusSports #Arsenal #Tottenham #Big6vsBig6 #HIGHLIGHTS
                    </p>
