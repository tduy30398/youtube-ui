            ...
            {isShowMore ? (
                <div className={cx('video-description-wrapper')}>
                    <p className={cx('video-description')}>
                        Đừng Khóc Một Mình
                        <br /> OFFICIAL LYRIC VIDEO
                        <br /> Download/Stream: https://zingmp3.vn/bai-hat/Dung-Khoc-...
                    </p>
                ...
                <div className={cx('video-description-wrapper')}>
                    <p className={cx('video-description')}>
                        ...
                        <br /> OFFICIAL LYRIC VIDEO
                        <br /> Download/Stream: https://zingmp3.vn/bai-hat/Dung-Khoc-...
                        <br /> Singer QUANG HUNG MASTERD
                        <br /> Composer QUANG HUNG MASTERD
                        <br /> Beat by NGUYEN CHUNG Manager KIM NGAN☞
                        <br />
                        <br /> Do not Reup
                        <br />
                        <br /> © 2019 Quang Hùng MasterD
                        <br />
                    </p>
